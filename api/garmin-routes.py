"""Vercel Python serverless function: POST /api/garmin-routes"""
...
class handler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        activity_type = str(body.get("activityType") or "running")
        ...
        try:
            payload = fetch_route_points(email, password, limit, activity_type)
